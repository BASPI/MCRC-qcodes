...
### Standalone CLI
A pre-built Windows executable (.exe) for controlling the Multichannel Remote Controller is available under [Releases]([insert Link](https://github.com/BASPI/MCRC-qcodes/releases))
